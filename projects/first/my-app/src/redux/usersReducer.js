...
const usersReducer = (state = initialStore, action) => {
  switch (action.type) {
    ...
    case CHANGE_STATUS_REQUEST: {
      // console.log(action, 'action', initialStore.requestIsActive)
      return {
        ...state, requestIsActive: { ...action.user }
      }
    }
...
export const changeStatusRequest = (requestStatus, userId) => ({
  type: CHANGE_STATUS_REQUEST, user: { requestStatus, userId }
})
